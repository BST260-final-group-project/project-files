...
Consistent with our intuition, if the overall quality of the house is better, then the house price is higher.
...
#### 5.5 Visualization of Correlation

![](./EDA_JJC_1.png){width=80%}
![](./EDA_JJC_2.png){width=80%}
![](./EDA_JJC_3.png){width=80%}
![](./EDA_JJC_4.png){width=80%}
![](./EDA_JJC_5.png){width=80%}
![](./EDA_JJC_6.png){width=80%}

Here we use the R package tabplots to find strong-related variables to “Saleprice” among 79 variables, which would further help us do feature selection and engineering.Of all numeric variables, Variables strongly correlated with hourse price (SalePrice) are: OverallQual, YearBuilt, YearRemodAdd, MasvnrArea, BsmtFinSF1, TotalBsmtSF, 1stFlrSF, GrLiveArea, FullBath, TotRmsAbvGrd, FirePlaces, GarageYrBlt, GarageCars, GarageArea, WoodDeskSF and OpenPorchSF, which is consistent with our findings in the headmap of correlations between variables.
...
#### 5.7 Ordinary Linear Regression
